<?php session_start();
if(isset($_SESSION['destroy'])){unset($_SESSION['destroy']);header('Location:Accueil_utilisateur.php');exit();}?>
<html>
<head>
...
<div class="corps" style="background-color: rgba(159,185,153,0);">
  <center>
    <div class="border" style ="width:40% ; margin:10px;padding:20px;overflow:auto;height:auto">
      <?php
        ...
        // On choppe les types
          if ($id_type_mat==1){echo "<br><h2 style='line-height:1.5em;width:auto;padding:5px;background:none;color:black'>🚚​​ Selectionnez le véhicule : </h3> <br>" ;}
          if ($id_type_mat==2){echo "<br><h2 style='line-height:1.5em;width:auto;padding:5px;background:none;color:black'>🐄​​​ Selectionnez le matériel de contention d'animaux : </h3> <br>" ;}
          if ($id_type_mat==3){echo "<br><h2 style='line-height:1.5em;width:auto;padding:5px;background:none;color:black'>🐓​​​ Selectionnez le matériel de naissance et élevage de volaille : </h3> <br>" ;}
          if ($id_type_mat==4){echo "<br><h2 style='line-height:1.5em;width:auto;padding:5px;background:none;color:black'>🗣️​​​ Selectionnez le matériel de support de communication : </h3> <br>" ;}
          if ($id_type_mat==5){echo "<br><h2 style='line-height:1.5em;width:auto;padding:5px;background:none;color:black'>🐝​​​ Selectionnez le matériel d'apiculture' : </h3> <br>" ;}
          if ($id_type_mat==6){echo "<br><h2 style='line-height:1.5em;width:auto;padding:5px;background:none;color:black'>🚚​​ Selectionnez le matériel de transport d'animaux : </h3> <br>" ;}
          if ($id_type_mat==7){echo "<br><h2 style='line-height:1.5em;width:auto;padding:5px;background:none;color:black'>🚚​​ Selectionnez le matériel : autre : </h3> <br>" ;}
        ...
        // Choix dates
          echo "<hr><h2 style='line-height:1.5em;width:auto;padding:5px;background:none;color:black;'> Choisissez les dates d'emprunt :</h2>";
          ...
          echo"<br><br><br>
          <label for='remarque_demande' style='font-size:1em;font-family:Verdana;font-weight: bold;'>  Remarque :  <br><br> </label>";

          if(isset($_GET["remarque_demande"])){
            echo "<textarea name='remarque_demande' row=10 cols=40>".$_GET['remarque_demande']."</textarea><br><br>";
          }
          else{
            echo "<center><textarea name='remarque_demande' row=10 cols=40></textarea></center><br><br>";
          }

          echo "<br><center><input type='submit' name='bouton1' value='Envoyer'>" ;
          echo "<input type='hidden' name='id_type_mat' value=".$_GET['id_type_mat']."></center>";
          echo " </form>" ;
...
<?php
            if(isset($_GET["bouton1"])) {
              ...
              VALUES (\"".$id_profil."\",'1','2','4',\"".$id_materiel."\",\"".$date_debut."\",\"".$date_fin."\",\"".date('Y-m-d')."\",\"".$quantite."\",\"".$commentaire."\")" ;
              ...
              if(mysqli_query($link,$demande_mat)){
                ...
                <h2 style='line-height:1.5em;width:auto;padding:5px;background:none;color:black;'> Retour au menu <a href='Accueil_utilisateur.php' style='font-size=1em'>🏠</a></h2>
                </dialogue>";
              }
              else{
