...
<body>
  ...
  <div class='header' style='margin:0 12px;'>
    ...
    <?php
    //si on venant déjà d'une autre page du site on recupere l'url de la page d'origine
    ...
    if(isset($_POST['identifiant_profil'])){
      ...
      //deux requetes: une pour verifier les identifiants et une pour les droits
      ...
      if (mysqli_num_rows($result)==1)
      {
        ...
        if(!isset($_SESSION["identifiant_profil"]) && $droit[0][0]==1)
        {
          ...
          if ($url=="valeur_par_defaut")
          {
            ...
            header("Location: Pages/Administrateur/Accueil_administrateur.php");
            exit();
          }
          else
          {
        ...
        if(!isset($_SESSION["identifiant_profil"]) && $droit[0][0]>1)
        {
          ...
          if ($conv==0 OR $conv==NULL ){
            header("Location: Pages/Utilisateur/Validation_consentement.php");
            exit();
          }
          else{
            if ($url == "valeur_par_defaut")
            {
              ...
              header("Location: Pages/Utilisateur/Accueil_utilisateur.php");
              exit();
            }
            else
            {
